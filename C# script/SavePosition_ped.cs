...
public class SavePosition_ped : MonoBehaviour
{
    ...
    */
    ...
    void Update()
    {
        ...
        Vector3 left_controller = GameObject.Find("----Pedestrian/Pedestrian Object/Player/SteamVRObjects/LeftHand").transform.position;
        Vector3 right_controller = GameObject.Find("----Pedestrian/Pedestrian Object/Player/SteamVRObjects/RightHand").transform.position;
